...
function expertsolutionsforflatroofrepairinnycandofficerenovationcontractorsinnewyork() {
  ...
  useEffect(() => {
    axios
      .get(
        `https://${URI}:3000/api/blogsDetails?slug=expert-solutions-for-flat-roof-repair-in-nyc-and-office-renovation-contractors-in-new-york`
      )
      .then((res) => {
        console.log(res, "res");
...
export default expertsolutionsforflatroofrepairinnycandofficerenovationcontractorsinnewyork;
