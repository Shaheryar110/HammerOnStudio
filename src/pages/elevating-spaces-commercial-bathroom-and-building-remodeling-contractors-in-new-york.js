...
function elevatingspacescommercialbathroomandbuildingremodelingcontractorsinnewyork() {
  ...
  useEffect(() => {
    axios
      .get(
        `https://${URI}:3000/api/blogsDetails?slug=elevating-spaces-commercial-bathroom-and-building-remodeling-contractors-in-new-york`
      )
      .then((res) => {
        console.log(res, "res");
...
export default elevatingspacescommercialbathroomandbuildingremodelingcontractorsinnewyork;
