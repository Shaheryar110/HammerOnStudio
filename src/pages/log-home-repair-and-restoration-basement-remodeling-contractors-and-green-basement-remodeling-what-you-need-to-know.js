...
function importanceofqualitykitchenandbathremodelsandflatroofrepair() {
  ...
  useEffect(() => {
    axios
      .get(
        `https://${URI}:3000/api/blogsDetails?slug=log-home-repair-and-restoration-basement-remodeling-contractors-and-green-basement-remodeling-what-you-need-to-know`
      )
      .then((res) => {
        console.log(res, "res");
...
export default importanceofqualitykitchenandbathremodelsandflatroofrepair;
