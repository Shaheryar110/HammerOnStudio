...
function loghomerepairandrestorationpreservingthebeautyofyourabode() {
  ...
  useEffect(() => {
    axios
      .get(
        `https://${URI}:3000/api/blogsDetails?slug=office-renovation-contractor-and-flat-roof-repair-why-you-need-professionals-for-your-commercial-building`
      )
      .then((res) => {
        console.log(res, "res");
...
export default loghomerepairandrestorationpreservingthebeautyofyourabode;
