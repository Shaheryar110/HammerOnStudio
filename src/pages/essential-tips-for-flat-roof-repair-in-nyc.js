...
function essentialtipsforflatroofrepairinnyc() {
  ...
  useEffect(() => {
    axios
      .get(
        `https://${URI}:3000/api/blogsDetails?slug=essential-tips-for-flat-roof-repair-in-nyc`
      )
      .then((res) => {
        console.log(res, "res");
...
export default essentialtipsforflatroofrepairinnyc;
