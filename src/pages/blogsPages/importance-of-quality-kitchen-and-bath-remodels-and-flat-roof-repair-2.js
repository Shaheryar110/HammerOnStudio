...
function importanceofqualitykitchenandbathremodelsandflatroofrepair2() {
  ...
  useEffect(() => {
    axios
      .get(
        `https://${URI}:3000/api/blogsDetails?slug=importance-of-quality-kitchen-and-bath-remodels-and-flat-roof-repair-2`
      )
      .then((res) => {
        console.log(res, "res");
...
export default importanceofqualitykitchenandbathremodelsandflatroofrepair2;
