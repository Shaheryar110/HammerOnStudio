      ...
      <Box sx={style.margins}>
        ...
        <Container sx={style.container}>
          ...
          <Typography sx={style.text}>
            ...
            Privacy Policy document contains information collected and recorded
            by Hammer-On Studios LLC and how we use it.
          </Typography>
          <Typography sx={style.text}>
          ...
          <Typography sx={style.text}>
            ...
            information, including name, company name, address, e-mail address,
          ...
          <Typography sx={style.text}>
            ...
            identifiable information. The information aims to analyze trends,
            administer the site, track user’s movement on the website, and
            gather demographic information.
          </Typography>
          <Typography sx={style.bold}>Cookies and Web Beacons</Typography>
          <Typography sx={style.text}>
            Like any other website, Hammer-On Studios LLC uses ‘cookies.’ These
            cookies store information, including visitors’ preferences and the
            website pages that the visitor accessed or visited. The information
          ...
          <Typography sx={style.text}>
            ...
            advertising partners of Hammer-On Studios LLC.
          </Typography>
          <Typography sx={style.text}>
            ...
            and links that appear on Hammer-On Studios LLC, which are sent
            directly to users’ browsers. They automatically receive your IP
            address when this occurs. These technologies are used to measure the
            effectiveness of their advertising campaigns and/or personalize the
          ...
          <Typography sx={style.bold}>Third-Party Privacy Policies</Typography>
          <Typography sx={style.text}>
          ...
          <Typography sx={style.text}>
            ...
            web browsers, it can be found at their respective websites
          </Typography>
          <Typography sx={style.bold}>
          ...
          <Typography sx={style.text}>
            Request that a business that collects a consumer’s data disclose the
          ...
          <Typography sx={style.text}>
            ...
            right to request that we complete the information you think is
            incomplete.
          </Typography>
          <Typography sx={style.text}>
          ...
          <Typography sx={style.text}>
            ...
            will do our best efforts to remove such information from our records
            promptly.
          </Typography>
        </Container>
      </Box>
